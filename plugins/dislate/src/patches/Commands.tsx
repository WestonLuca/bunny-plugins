    ...
    options: [
        {
            name: "text",
            displayName: "text",
            description: "The text/message for Dislate to translate.",
            displayDescription: "The text/message for Dislate to translate.",
        ...
        },
        {
            ...
            description: "The language that Dislate will translate the text into.",
            displayDescription: "The language that Dislate will translate the text into.",
            type: ApplicationCommandOptionType.STRING as number,
            // @ts-ignore
    ...
    async execute(args, ctx) {
        ...
        try {
            ...
            switch (settings.translator) {
                ...
                case 2:
                    content = await Gemini.translate(text.value, undefined, lang.value)
                    break
